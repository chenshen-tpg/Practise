package CodingQuestions.Random.SmallShit;
import java.io.*;
...
public class Read {
    ...
    public static void getFile() {
        ...
        try {
            File csvFile = new File("C:\\Users\\Administrator\\IdeaProjects\\untitled\\src\\Random\\SmallShit\\template.xlsx");
            ...
            print(customerDetails);
                ...
                System.out.println("way of read file is wrong！");
            }
    }
