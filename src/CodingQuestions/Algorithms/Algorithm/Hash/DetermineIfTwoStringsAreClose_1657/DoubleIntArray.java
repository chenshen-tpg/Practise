package CodingQuestions.Algorithms.Algorithm.Hash.DetermineIfTwoStringsAreClose_1657;
...
public class DoubleIntArray {
    ...
    public boolean helper (String word1, String word2) {
        ...
        for (char c : word1.toCharArray()) word1Map[c - 'a']++;
        for (char c : word2.toCharArray()) word2Map[c - 'a']++;
        for (int i = 0; i < 26; i++) {
