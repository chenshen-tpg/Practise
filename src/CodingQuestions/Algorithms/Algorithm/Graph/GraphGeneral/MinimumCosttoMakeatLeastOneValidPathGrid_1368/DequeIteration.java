package CodingQuestions.Algorithms.Algorithm.Graph.GraphGeneral.MinimumCosttoMakeatLeastOneValidPathGrid_1368;
...
public class DequeIteration {
    ...
    public int minCost(int[][] grid) {
        ...
        for (int i = 0; i < m; i++)  Arrays.fill(minCost[i], Integer.MAX_VALUE);
