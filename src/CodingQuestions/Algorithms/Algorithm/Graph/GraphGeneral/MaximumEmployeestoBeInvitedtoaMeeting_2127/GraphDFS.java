package CodingQuestions.Algorithms.Algorithm.Graph.GraphGeneral.MaximumEmployeestoBeInvitedtoaMeeting_2127;
...
public class GraphDFS {
    ...
    public int maximumInvitations(int[] favorite) {
        ...
        for (int i = 0; i < numPeople; i++) reversedGraph.add(new ArrayList<>());
        for (int person = 0; person < numPeople; person++) reversedGraph.get(favorite[person]).add(person);
        int longestCycle = 0;
