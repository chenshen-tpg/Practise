...
public class FindFirstAndLastPositionOfElementinSortedArray_34_med {
    public static void main(String[] args) {
        FindFirstAndLastPositionOfElementinSortedArray_34_med ffl = new FindFirstAndLastPositionOfElementinSortedArray_34_med();
